...
public sealed class NotificationLogConfiguration : IEntityTypeConfiguration<NotificationLog>
{
    public void Configure(EntityTypeBuilder<NotificationLog> builder)
    {
        ...
        builder.Property(nl => nl.Status).HasConversion<string>().HasMaxLength(20).HasDefaultValue("Sent");
        ...
        builder.HasOne(nl => nl.User).WithMany(u => u.NotificationLogs).HasForeignKey(nl => nl.UserId).OnDelete(DeleteBehavior.Cascade);
