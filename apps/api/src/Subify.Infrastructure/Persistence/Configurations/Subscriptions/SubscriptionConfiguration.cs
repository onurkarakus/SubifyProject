...
public sealed class SubscriptionConfiguration : IEntityTypeConfiguration<Subscription>
{
    public void Configure(EntityTypeBuilder<Subscription> builder)
    {
        ...
        builder.Property(s => s.Status).HasConversion<string>().HasMaxLength(20).HasDefaultValue("Active");
        ...
        builder.HasOne(s => s.UserCategory).WithMany(uc => uc.Subscriptions).HasForeignKey(s => s.UserCategoryId).OnDelete(DeleteBehavior.SetNull);
