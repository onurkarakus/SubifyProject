...
public sealed class SubscriptionConfiguration : IEntityTypeConfiguration<Subscription>
{
    public void Configure(EntityTypeBuilder<Subscription> builder)
    {
        ...
        builder.Property(s => s.Amount).HasPrecision(10, 2).IsRequired();
        ...
        builder.Property(s => s.NextPaymentDate).IsRequired();
        ...
        builder.HasIndex(s => new { s.UserId, s.Archived, s.NextPaymentDate }).HasDatabaseName("IX_Subscriptions_UserId_Archived_NextPaymentDate");
        ...
        builder.HasIndex(s => new { s.NextPaymentDate, s.Archived, s.Status }).HasDatabaseName("IX_Subscriptions_NextPaymentDate_Active");
