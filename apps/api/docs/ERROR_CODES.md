...
| Code      | HTTP | Title                      | Detail                                                       | Çözüm                     |
| --------- | ---- | -------------------------- | ------------------------------------------------------------ | ------------------------- |
| `SUB_001` | 403  | Subscription Limit Reached | Free plan allows maximum 3 subscriptions. Upgrade to premium | Premium'a geç             |
...
| Code     | HTTP | Title                        | Detail                                                    | Çözüm                  |
| -------- | ---- | ---------------------------- | --------------------------------------------------------- | ---------------------- |
| `AI_001` | 403  | Premium Required             | AI suggestions require a premium subscription             | Premium'a geç          |
